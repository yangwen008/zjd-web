      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            ...
            {/* PC微信扫码登录 - 独立页面链接，不影响手机端 */}
            <a
              href="/wx-scan-login"
              className="w-full mt-3 flex items-center justify-center space-x-2 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
            >
              <svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24">
                <path d="M3 3h6v2H5v4H3V3zm12 0h6v6h-2V5h-4V3zM3 15h2v4h4v2H3v-6zm16 0h2v6h-6v-2h4v-4z"/>
              </svg>
              <span className="text-sm text-gray-600 font-medium">微信扫码登录（PC端）</span>
            </a>
          </div>
        </div>
