...
export const revalidate = 3600; // 1小时缓存，首页数据变化不频繁
...
function toPropertyFormat(asset: Asset, defaultImage: string) {
  return {
    ...
    badge: (asset as any).source_site ? '第三方' : (((asset as any).publisher_role === 'project_publisher') ? '交易所' : (asset.source_type === 'official' ? '官方' : asset.source_type === 'village' ? '村委' : '个人')),
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {latestAssets.map((a) => {
                  const badge = (a as any).source_site ? '第三方' : (a.source_type === 'official' ? '官方' : a.source_type === 'village' ? '村委' : '个人');
                  return (
