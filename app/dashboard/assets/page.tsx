      ...
      <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-50">
            ...
            }) : <tr><td colSpan={6} className="px-4 py-8 text-center text-gray-400">暂无资产，<Link href="/dashboard/assets/new" className="text-brand-green hover:underline">去发布</Link></td></tr>}
          </tbody>
        </table>
      </div>
    </div>
